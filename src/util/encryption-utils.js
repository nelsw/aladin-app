...
// const encryptKey = config.get("Common.encryptKey");
...
export const decryptAESKey = async (encryptedKey) => {
  // console.log("INSIDE AES")
  try {
      var bytes = CryptoJS.AES.decrypt(encryptedKey.toString(), "ALADIN FOREVER");
